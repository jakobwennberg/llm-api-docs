# Revenueforecastversionscheduler.Htm
...
|  pse.RevenueForecastVersionScheduler global with sharing class RevenueForecastVersionScheduler implements Schedulable This schedulable class provides functionality relating to revenue forecast versions.
## Methods
  * [global RevenueForecastVersionScheduler()](https://help.certinia.com/TechnicalReference/2025.1/ProfessionalServicesAutomation/Apex/RevenueForecastVersionScheduler.htm#RevenueForecastVersionScheduler0)
  * [global void execute(SchedulableContext context)](https://help.certinia.com/TechnicalReference/2025.1/ProfessionalServicesAutomation/Apex/RevenueForecastVersionScheduler.htm#execute0)

RevenueForecastVersionScheduler _global RevenueForecastVersionScheduler()_ A constructor that creates a new [pse.RevenueForecastVersionScheduler](https://help.certinia.com/TechnicalReference/2025.1/ProfessionalServicesAutomation/Apex/RevenueForecastVersionScheduler.htm#RevenueForecastVersionScheduler) instance.   
execute _global void execute(SchedulableContext context)_ Executes the scheduled Apex job for creating revenue forecast versions.
#### Input Parameters
| Name | Type | Description  
---|---|---  
context | SchedulableContext | Contains the job ID.  
